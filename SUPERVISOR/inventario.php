...
if ($resultado->num_rows >= 0) {
    ...
    <th style=width:400px;> Se presto a</th>
    <th style=width:150px;> Fecha de Prestamo </th>
    <th style=width:200px;> Fecha de devolucion</th>
    ...
    while ($fila = $resultado->fetch_assoc()) { 
        ...
        echo "<td>" . $fila['diahora_p'] . "</td>";
        echo "<td>" . $fila['devolucion'] . "</td>";
        echo "<td><a href='editarobjeto.php?cod_inventario=" . $fila['cod_inventario'] . "&nom_inventario=" . $fila['nom_inventario'] ."&estado=" . $fila['estado'] . "&diahora_p=" . $fila['diahora_p'] . "'><img src='imagenes/editar.png' /></a><h>--</h><a href='eliminar_objeto.php?cod_inventario=" . $fila['cod_inventario'] . "'><img src='imagenes/eliminar.png' /></a></td>";
        echo "</tr>";
    }
