...
<body>
    ...
    <?php
        ...
        $rol_b = "Estudiante";
        $sql = "SELECT i.nombre_persona, i.nom_inventario, i.estado, i.diahora_p, i.devolucion FROM inventario as i LEFT JOIN usuarios as e ON i.nombre_persona = e.nombre WHERE e.nombre = '$nombre' AND e.rol = '$rol_b'";
        ...
        echo "<table border='1'>";
        echo "<th style=width:240px;>Estudiante</th><th style=width:150px;>Nombre del equipo</th><th>Estado</th><th style=width:150px;>Fecha de prestamo</th><th style=width:150px;>Estado del prestamo</th></tr>";
